...
public class BookCollection implements InitializingBean,DisposableBean{
	...
	public void  MyInitMethod(){ 
		System.out.println("..myInitMethod is called of BookCollection..");
		
	}
	public void myDestroyedMethod(){
		System.out.println("...Destroyed method is called  BookCollection...");
	}

	@Override
	public void destroy() throws Exception {
		System.out.println("DisposableBean int method is called");
